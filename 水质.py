...
def calc_score(df1, df2):
    rmse_1 = np.sqrt(tf.losses.mean_squared_error(df1['pred'], (df1['Label1'])))
    rmse_2 = np.sqrt(tf.losses.mean_squared_error(df2['pred'], (df2['Label2'])))
...
sub.to_csv("E:/result.csv", index=False)
